...
cat(paste('### ', 'Import Results', '\n', sep = ''), file = paste(label_topic, '_wrap', label_name, 'summary.md', sep = '//'), append = TRUE)
...
cat('\n', file = paste(label_topic, '_wrap', label_name, 'summary.md', sep = '//'), append = TRUE)
...
exdir <- paste(label_home, label_user, label_character, label_project, label_topic, '_tmp', sep = '//')
