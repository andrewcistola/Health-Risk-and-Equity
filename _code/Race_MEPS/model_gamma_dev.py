...
df.reset_index()
df = df.rename(columns = {'index': 'Variable'}) # Rename selected columns with dictionary
df.to_csv(r'_data/AIM3_disparity_COST.csv', index = False) # Write dataframe to CSV
desc_COST = df
...
df.reset_index()
df = df.rename(columns = {'index': 'Variable'}) # Rename selected columns with dictionary
df.to_csv(r'_data/AIM3_disparity_HEALTH.csv', index = False) # Write dataframe to CSV
desc_HEALTH = df