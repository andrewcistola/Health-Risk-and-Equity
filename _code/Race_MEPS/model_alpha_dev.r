...
cat(c('\n'), file = file, append = TRUE)
cat(c('W (ID variables): ', W, '\n'), file = file, append = TRUE)
cat(c('X (Predictor variables): ', X, '\n'), file = file, append = TRUE)
cat(c('Y (Outcome variables): ', Y, '\n'), file = file, append = TRUE)
cat(c('Z (Subgroup variables): ', Z, '\n'), file = file, append = TRUE)
cat(c('\n'), file = file, append = TRUE)
skim(df_WXYZ)
cat(c('\n'), file = file, append = TRUE)
sink()
...
png(paste('_fig/', G, '_QQ_', W, '_plot.png', sep = ''))
qqnorm(resid(OLS))
qqline(resid(OLS))
dev.off()
...
png(paste('_fig/', G, '_residuals_', W, '_plot.png', sep = ''))
plot(resid(OLS))
abline(0,0)
dev.off()
...
ggsave(paste('_fig/', G, '_correlation_', W, '_plot.png', sep = ''), plot = plot) # Save ggplot as jpeg
...
### Create Linear Regression Model with polynomial transformation
df_WXYZ['Y_sq'] = df_WXYZ[Y]^2
glm_2 = 'DV = Y^2, regression = linear'
D = subset(df_WXYZ, select = c(X, 'Y_sq', Z))
F = as.formula(paste('Y_sq', ' ~ ', paste(c(X, Z), collapse = ' + '), sep = ''))
...
summary(GLM_0)
cat(c('F-Test for overdispersion: ', test_0, '\n'), file = file, append = TRUE)
cat(c('\n'), file = file, append = TRUE)
cat(c('##### Log Transform Y', '\n\n'), file = file, append = TRUE)
cat(c('Generalized model for', glm_1, '\n'), file = file, append = TRUE)
summary(GLM_1)
cat(c('F-Test for overdispersion: ', test_1, '\n'), file = file, append = TRUE)
cat(c('\n'), file = file, append = TRUE)
cat(c('##### Y Squared', '\n\n'), file = file, append = TRUE)
cat(c('Generalized model for', glm_2, '\n'), file = file, append = TRUE)
summary(GLM_2)
cat(c('F-Test for overdispersion: ', test_2, '\n'), file = file, append = TRUE)
cat(c('\n'), file = file, append = TRUE)
cat(c('##### Logistic', '\n\n'), file = file, append = TRUE)
cat(c('Generalized model for', glm_3, '\n'), file = file, append = TRUE)
summary(GLM_3)
cat(c('F-Test for overdispersion: ', test_3, '\n'), file = file, append = TRUE)
cat(c('\n'), file = file, append = TRUE)
cat(c('##### Poisson', '\n\n'), file = file, append = TRUE)
cat(c('Generalized model for', glm_4, '\n'), file = file, append = TRUE)
summary(GLM_4)
cat(c('F-Test for overdispersion: ', test_4, '\n'), file = file, append = TRUE)
cat(c('\n'), file = file, append = TRUE)
cat(c('##### Negative Binomial', '\n\n'), file = file, append = TRUE)
cat(c('Generalized model for', glm_5, '\n'), file = file, append = TRUE)
summary(GLM_5)
cat(c('\n'), file = file, append = TRUE)
cat(c('F-Test for overdispersion: ', test_5, '\n'), file = file, append = TRUE)
cat(c('\n'), file = file, append = TRUE)
sink()
